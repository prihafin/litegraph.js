...
(function(p) {
  ...
  r.prototype.start = function(a) {
    if (this.status != r.STATUS_RUNNING) {
      ...
      if (0 == a && "undefined" != typeof window && window.requestAnimationFrame) {
        var c = function() {
          -1 == b.execution_timer_id && (window.requestAnimationFrame(c), b.runStep(1, !globalThis.catch_errors));
        };
        this.execution_timer_id = -1;
        c();
      } else {
        this.execution_timer_id = setInterval(function() {
          b.runStep(1, !globalThis.catch_errors);
        }, a);
      }
    }
  };
  ...
  k.prototype.showLinkMenu = function(a, b) {
    var c = this, e = new d.ContextMenu(["Add Node", null, "Delete"], {event:b, title:null != a.data ? a.data.constructor.name : null, callback:function(b, d, g) {
      switch(b) {
        case "Add Node":
  ...
  globalThis.CanvasRenderingContext2D && (CanvasRenderingContext2D.prototype.roundRect = function(a, b, c, e, f, d) {
    void 0 === f && (f = 5);
    void 0 === d && (d = f);
    this.moveTo(a + f, b);
    this.lineTo(a + c - f, b);
